...
describe "/home/rps_calc" do
  ...
  it "should convert to RPS by default" do
    request("/home/rps_calc", :params => {:requests_per => 8_640_000}).should contain('reqs/day is 100.0 reqs/sec')
  end
  ...
  describe "converting into RPS" do
    it "should return 100 RPS for a input of 8.64 million" do
      request("/home/rps_calc", :params => {:requests_per => 8_640_000}).should contain('100.0')
    end
    it "should return 0.1 RPS for an input of 8.64k" do 
      request("/home/rps_calc", :params => {:requests_per => 8_640}).should contain('0.1')
    end
  ...
  describe "converting into RPD" do
    it "should return 8.64 million reqs/day for a input of 100 reqs/sec" do
      request("/home/rps_calc", :params => {:requests_per => 100, :convert_to => 'rpd'}).should contain('100 reqs/sec is 8640000.0 reqs/day')
    end
    it "should return 8.64k reqs/day for a input of 0.1 reqs/sec" do
      request("/home/rps_calc", :params => {:requests_per => 0.1, :convert_to => 'rpd'}).should contain('0.1 reqs/sec is 8640.0 reqs/day')
    end
  end
